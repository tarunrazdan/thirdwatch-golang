...
type Seller struct {
	...
	SellerId string `json:"_sellerId,omitempty"`
	...
	CreatedDate string `json:"_createdDate,omitempty"`

	// Date when seller profile uopdated last time.
	LastUpdatedDate string `json:"_lastUpdatedDate,omitempty"`

	// Ip address used by seller while registration.
	OnboardingIpAddress string `json:"_onboardingIpAddress,omitempty"`
}
