...
type SubmitReview struct {
	...
	ReviewTitle string `json:"_reviewTitle,omitempty"`

	// The text content of review submitted.
	ReviewContent string `json:"_reviewContent,omitempty"`
	...
	SubmissionStatus string `json:"_submissionStatus,omitempty"`

	// The rating provided by the user. e.g. \"4\"
	Rating string `json:"_rating,omitempty"`
