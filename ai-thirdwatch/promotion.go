...
type Promotion struct {
	...
	PromotionId string `json:"_promotionId,omitempty"`
	...
	MinPurchaseAmount string `json:"_minPurchaseAmount,omitempty"`
	...
	PercentageOff string `json:"_percentageOff,omitempty"`
