...
type ShippingAddress struct {
	...
	Address1 string `json:"_address1,omitempty"`

	// Address second line, e.g., \"Nirvana Country, Sector 50\".
	Address2 string `json:"_address2,omitempty"`

	// The city or town name, e.g., \"Gurgaon\" .
	City string `json:"_city,omitempty"`
	...
	Zipcode string `json:"_zipcode,omitempty"`

	// Is user chosen this address as office address.
	IsOfficeAddress bool `json:"_isOfficeAddress,omitempty"`

	// Is user chosen this address as home address.
	IsHomeAddress bool `json:"_isHomeAddress,omitempty"`
}
