...
type UpdateOrder struct {
	...
	HasExpeditedShipping bool `json:"_hasExpeditedShipping,omitempty"`

	// Indicates the method of delivery to the user. e.g. _electronic, _physical
	ShippingMethod string `json:"_shippingMethod,omitempty"`

	// Referer website or user name.
	OrderReferrer string `json:"_orderReferrer,omitempty"`

	// is order is prepaid.
	IsPrePaid bool `json:"_isPrePaid,omitempty"`

	// Is user chosen gift pack.
	IsGift bool `json:"_isGift,omitempty"`

	// Is this return order.
	IsReturn bool `json:"_isReturn,omitempty"`

	// Is user first time buyer.
	IsFirstTimeBuyer bool `json:"_isFirstTimeBuyer,omitempty"`
